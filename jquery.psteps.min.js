 ...
 */
(function(e){e.fn.psteps=function(k){var s=e.extend({},e.fn.psteps.defaults,k);this.each(function(){var a=e(this);a.psteps_version="0.0.1alpha";if(a.hasClass("steps-transformed"))return true;a.addClass("steps-transformed");a.extend(a,s);var o=a.find(".step-content"),l=a.find(".step-title"),c=a.find(".step-name"),p=a.find(".next-button"),f=a.find(".back-button"),m=a.find(".submit-button"),h=a.find(".next-button, .submit-button"),q=a.find(".step-title").length,r=true,n=false;a.get_max_height=function(a){var d=
...
a.toggle_buttons_function=function(){a.find(".step-content").last().hasClass("step-active")?(p.hide(),m.show()):(p.show(),m.hide());var b=a.find(".step-title.step-active");b.hasClass("btn-success")||b.hasClass("step-warning")?h.removeClass("btn-info").addClass("btn-success"):b.hasClass("btn-info")?h.removeClass("btn-success").addClass("btn-info"):b.hasClass("step-error")&&h.removeClass("btn-success btn-info").addClass("btn-danger");if(a.validate_submit_all_steps){var d;l.each(function(){var b=d;e(this).hasClass("btn-success")||
(d=true);e(this).hasClass("step-warning")&&!b&&(d=false);e(this).hasClass("step-error")&&!b&&a.ignore_errors_on_submit&&(d=false)});d&&m.removeClass("btn-success").addClass("btn-info")}a.back?a.find(".step-title").first().hasClass("step-active")?f.hide():(b=a.find(".step-title.step-active").prevAll(".step-title:first"),b.hasClass("btn-info")?f.removeClass("btn-success btn-warning btn-danger").addClass("btn-info").css("cursor","pointer"):b.hasClass("btn-success")?f.removeClass("btn-info btn-warning btn-danger").addClass("btn-success").css("cursor",
"pointer"):b.hasClass("btn-warning")?f.removeClass("btn-info btn-success btn-danger").addClass("btn-warning").css("cursor","pointer"):b.hasClass("btn-danger")&&f.removeClass("btn-success btn-warning btn-info").addClass("btn-danger").css("cursor","pointer"),f.show()):f.hide()};a.go_to_step=function(b){var d=1,g=a.find(".step-title.last-active"),c=a.find(".step-content.last-active"),f=a.find(".step-content.step-active"),h=a.find(".step-title.step-active"),j,i;b>q||(a.find(".step-content").each(function(){d==
b&&(j=e(this));d++}),d=1,a.find(".step-title").each(function(){d==b&&(i=e(this));d++}),j.hasClass("step-loaded")||a.steps_onload.call(j),a.steps_hide.call(f),g.removeClass("last-active"),c.removeClass("last-active"),f.hide().removeClass("step-active").addClass("last-active"),j.show().addClass("step-active step-visited step-loaded"),a.steps_show.call(j),h.removeClass("step-active").addClass("disabled last-active"),i.addClass("step-active step-visited").removeClass("disabled"),a.traverse_titles=="visited"&&
h.css("cursor","pointer"),r?r=false:a.check_progress_titles())};a.next_step_function=function(){var b=a.find(".step-title.step-active").prevAll(".step-title").length+2;a.go_to_step(b)};a.previous_step_function=function(){var b=a.find(".step-title.step-active").prevAll(".step-title").length;a.go_to_step(b)};a.traverse_titles_function=function(){a.change_traverse(a.traverse_titles)};a.change_traverse=function(b){b=="always"?(b=a.find(".step-title"),b.unbind("click"),b.click(function(){var b=e(this).prevAll(".step-title").length+
1;a.go_to_step(b)}).css("cursor","pointer")):b=="visited"?(a.find(".step-title.step-visited").css("cursor","pointer"),a.off("click",".step-title.step-visited"),a.on("click",".step-title.step-visited",function(){var b=e(this);b.prevAll(".step-title:first").hasClass("step-active")?a.next_step_function():b.nextAll(".step-title:first").hasClass("step-active")?a.previous_step_function():(b=b.prevAll(".step-title").length+1,a.go_to_step(b))})):b=="never"&&(b=a.find(".step-title"),b.css("cursor","default"),
a.off("click",".step-title.step-active"),a.on("click",".step-title.step-active",function(){var b=e(this).prevAll(".step-title").length+1;a.go_to_step(b)}))};a.trigger_error=function(b){var d=b.prevAll(".step-content").length+1,c,f=1;a.find(".step-title").each(function(){f==d&&(c=e(this));f++});c.hasClass("step-warning")?(c.removeClass("btn-info btn-success").addClass("btn-warning"),a.check_marks&&c.find("i.step-mark").remove().end().prepend('<i class="icon-remove step-mark"></i> ')):c.hasClass("step-error")&&
(c.removeClass("btn-info btn-success").addClass("btn-danger"),a.check_marks&&c.find("i.step-mark").remove().end().prepend('<i class="icon-remove step-mark"></i> '))};o.hide().first().addClass("step-visited step-active").show();l.addClass("disabled btn").first().addClass("step-visited step-active").removeClass("disabled");a.step_names||c.hide();a.traverse_titles_function();a.check_progress_titles();a.content_headings&&a.make_step_content_headings();a.start_incomplete_step?(c=a.find(".step-title.btn-info").first().prevAll(".step-title"),
c=c.length+1,a.go_to_step(c)):a.start_warning_step?(c=a.find(".step-title.step-warning").first().prevAll(".step-title"),c=c.length+1,a.go_to_step(c)):a.start_error_step?(c=a.find(".step-title.step-error").first().prevAll(".step-title"),c=c.length+1,a.go_to_step(c)):a.go_to_step(a.step_start);f.click(function(){a.previous_step_function()});a.bind("validate_psteps",function(){n=true;a.check_progress_titles()});a.bind("traverse_never",function(){a.change_traverse("never")});a.bind("traverse_always",
function(){a.change_traverse("always")});a.bind("traverse_visited",function(){a.change_traverse("visited")});a.bind("load_after_steps",function(){a.load_after_steps.call(a)});o.bind("psteps_step_error",function(){a.trigger_error(e(this))});l.bind("go_to_step",function(){var b=e(this).prevAll(".step-title").length+1;a.go_to_step(b)});a.bind("go_to_first_incomplete",function(){var b=a.find(".step-title.btn-info:first").prevAll(".step-title").length+1;a.go_to_step(b)});a.bind("go_to_first_warning",function(){var b=
a.find(".step-title.step-warning:first").prevAll(".step-title").length+1;a.go_to_step(b)});a.bind("go_to_first_error",function(){var b=a.find(".step-title.step-error:first").prevAll(".step-title").length+1;a.go_to_step(b)});h.click(function(b){var c=e(this);n?n=false:a.check_progress_titles();var f=a.find(".step-title.step-active");if(f.hasClass("step-error")&&a.validate_errors&&!a.validate_next_step)a.validate_use_error_msg?alert(a.validate_error_msg):f.click();else if(!f.hasClass("step-error")||
!a.validate_next_step||a.ignore_errors_on_next)f.hasClass("step-error")&&a.ignore_errors_on_next?a.next_step_function():c.hasClass("btn-success")?a.next_step_function():c.hasClass("submit-button")&&(a.validate_submit_all_steps||a.validate_next_step)?(a.use_before_submit&&alert(a.before_submit),b.preventDefault()):a.validate_next_step&&a.use_before_next?alert(a.before_next):a.next_step_function()});this.pines_steps=a});return this};e.fn.psteps.defaults={traverse_titles:"never",content_headings:false,
step_order:true,step_names:true,check_marks:true,alter_width_at_viewport:"1000",steps_width_percentage:false,steps_height_equalize:false,content_height_equalize:false,alter_names_at_viewport:"650",shrink_step_names:true,back:true,step_start:"1",steps_onload:function(){},steps_show:function(){},steps_hide:function(){},start_incomplete_step:false,start_warning_step:false,start_error_step:false,validation_rule:function(){return true},validate_next_step:true,validate_submit_all_steps:true,validate_errors:true,
