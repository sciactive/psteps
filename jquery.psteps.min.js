 ...
 */
(function(f){f.fn.psteps=function(o){var c=f.extend({},f.fn.psteps.defaults,o);this.each(function(){var a=f(this);a.psteps_version="0.0.1alpha";if(a.hasClass("steps-transformed"))return true;a.addClass("steps-transformed");a.opts=c;var i=a.find(".step-content"),p=a.find(".step-title"),o=a.find(".step-name"),k=a.find(".next-button"),g=a.find(".back-button"),j=a.find(".submit-button"),l=a.find(".next-button, .submit-button"),r=a.find(".step-title").length,m=true;a.get_max_height=function(a){var c=-1;
...
b.find("i.step-mark").remove().end().prepend('<i class="icon-remove step-mark"></i> ')):b.hasClass("step-error")&&(b.removeClass("btn-info btn-success").addClass("btn-danger"),c.check_marks&&b.find("i.step-mark").remove().end().prepend('<i class="icon-remove step-mark"></i> '))};i.hide().first().addClass("step-visited step-active").show();p.addClass("disabled btn").first().addClass("step-visited step-active").removeClass("disabled");c.step_names||o.hide();a.change_traverse(c.traverse_titles);a.check_progress_titles();
c.content_headings&&a.make_step_content_headings();var h;c.start_incomplete_step?(i=a.find(".step-title.step-info-incomplete").first(),i.length?a.go_to_step(i.prevAll(".step-title").length+1):(h=a.find(".step-title.btn-success").last(),a.go_to_step(h.prevAll(".step-title").length+1))):c.start_warning_step?(i=a.find(".step-title.step-info-warning").first(),i.length?a.go_to_step(i.prevAll(".step-title").length+1):(h=a.find(".step-title.btn-success").last(),a.go_to_step(h.prevAll(".step-title").length+
1))):c.start_error_step?(i=a.find(".step-title.step-info-error").first(),i.length?a.go_to_step(i.prevAll(".step-title").length+1):(h=a.find(".step-title.btn-success").last(),a.go_to_step(h.prevAll(".step-title").length+1))):a.go_to_step(c.step_start);g.click(function(){if(c.use_custom_back_button){var b=a.find(".step-title.step-active").prevAll(".step-title").length;c.custom_back_button_click.call(void 0,b)}else a.go_to_prev_step()});var s=0;a.bind("validate.psteps",function(b){b.timeStamp<s+500?
...
a.on("go_to_step.psteps",".step-title",function(){var b=f(this).prevAll(".step-title");a.go_to_step(b.length+1)});a.bind("go_to_first_incomplete.psteps",function(){var b=a.find(".step-title.step-info-incomplete").first();b.length?a.go_to_step(b.prevAll(".step-title").length+1):(h=a.find(".step-title.btn-success").last(),a.go_to_step(h.prevAll(".step-title").length+1))});a.bind("go_to_first_warning.psteps",function(){var b=a.find(".step-title.step-info-warning").first();b.length?a.go_to_step(b.prevAll(".step-title").length+
1):(h=a.find(".step-title.btn-success").last(),a.go_to_step(h.prevAll(".step-title").length+1))});a.bind("go_to_first_error.psteps",function(){var b=a.find(".step-title.step-info-error").first();b.length?a.go_to_step(b.prevAll(".step-title").length+1):(h=a.find(".step-title.btn-success").last(),a.go_to_step(h.prevAll(".step-title").length+1))});l.click(function(b){var e=f(this);if(e.hasClass(c.btn_wait_class))setTimeout(function(){a.trigger("validate.psteps");var d=a.find(".step-title.step-active");
