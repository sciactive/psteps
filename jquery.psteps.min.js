...
(b=a.find(".step-title"),b.css("min-height",m),b.css("min-height",a.get_max_height(b)));c.content_height_equalize&&setTimeout(function(){var b=a.find(".step-content");b.css("min-height",t);b.css("min-height",a.get_max_height(b))},2E3)}).resize()}a.check_progress_titles=function(){a.find(".step-content").each(function(b){var e=f(this),d="pstep"+(b+1);e.addClass(d);b=a.find(".step-title").eq(b);b.addClass(d);if(c.traverse_titles=="visited"&&b.hasClass("step-visited")||c.traverse_titles=="never"&&b.hasClass("step-visited")||
c.traverse_titles=="always")d=c.validation_rule.call(e),d=="warning"?(b.removeClass("step-error btn-info btn-success btn-warning btn-danger").addClass("step-warning"),a.trigger_error(e)):d=="error"?(b.removeClass("step-warning btn-info btn-success btn-warning btn-danger").addClass("step-error"),a.trigger_error(e)):d?(b.removeClass("step-warning btn-info btn-warning btn-danger step-error").addClass("btn-success"),c.check_marks&&b.find("i.step-mark").remove().end().prepend('<i class="icon-ok step-mark"></i> ')):
d||b.removeClass("step-warning btn-info btn-success btn-danger btn-warning step-error").addClass("btn-info").find("i.step-mark").remove()});a.toggle_buttons_function();a.trigger("validation_complete")};a.toggle_buttons_function=function(){a.find(".step-content").last().hasClass("step-active")?(p.hide(),n.show()):(p.show(),n.hide());var b=a.find(".step-title.step-active");b.hasClass("btn-success")||b.hasClass("step-warning")?j.removeClass("btn-info").addClass("btn-success"):b.hasClass("btn-info")?
...
"pointer"):b.hasClass("btn-success")?h.removeClass("btn-info btn-warning btn-danger").addClass("btn-success").css("cursor","pointer"):b.hasClass("btn-warning")?h.removeClass("btn-info btn-success btn-danger").addClass("btn-warning").css("cursor","pointer"):b.hasClass("btn-danger")&&h.removeClass("btn-success btn-warning btn-info").addClass("btn-danger").css("cursor","pointer"),h.show()):h.hide()};a.go_to_step=function(b){var e=1,d=a.find(".step-title.last-active"),g=a.find(".step-content.last-active"),
h=a.find(".step-content.step-active"),i=a.find(".step-title.step-active"),k,j;b>q||(a.find(".step-content").each(function(){e==b&&(k=f(this));e++}),e=1,a.find(".step-title").each(function(){e==b&&(j=f(this));e++}),c.steps_hide.call(h),d.removeClass("last-active"),g.removeClass("last-active"),h.hide().removeClass("step-active").addClass("last-active"),k.show().addClass("step-active step-visited"),i.removeClass("step-active").addClass("disabled last-active"),j.addClass("step-active step-visited").removeClass("disabled"),
k.hasClass("step-loaded")||c.steps_onload.call(k),k.addClass("step-loaded"),c.steps_show.call(k),c.traverse_titles=="visited"&&i.css("cursor","pointer"),r?r=false:a.trigger("validate_psteps"),a.toggle_buttons_function())};a.next_step_function=function(){var b=a.find(".step-title.step-active").prevAll(".step-title").length+2;a.go_to_step(b)};a.previous_step_function=function(){var b=a.find(".step-title.step-active").prevAll(".step-title").length;a.go_to_step(b)};a.traverse_titles_function=function(){a.change_traverse(c.traverse_titles)};
...
a.previous_step_function():(b=b.prevAll(".step-title").length+1,a.go_to_step(b))})):b=="never"&&(b=a.find(".step-title"),b.css("cursor","default"),a.off("click",".step-title.step-active"),a.on("click",".step-title.step-active",function(){var b=f(this).prevAll(".step-title").length+1;a.go_to_step(b)}))};a.trigger_error=function(b){var e=b.prevAll(".step-content").length+1,d,g=1;a.find(".step-title").each(function(){g==e&&(d=f(this));g++});d.hasClass("step-warning")?(d.removeClass("btn-info btn-success").addClass("btn-warning"),
c.check_marks&&d.find("i.step-mark").remove().end().prepend('<i class="icon-remove step-mark"></i> ')):d.hasClass("step-error")&&(d.removeClass("btn-info btn-success").addClass("btn-danger"),c.check_marks&&d.find("i.step-mark").remove().end().prepend('<i class="icon-remove step-mark"></i> '))};o.hide().first().addClass("step-visited step-active").show();i.addClass("disabled btn").first().addClass("step-visited step-active").removeClass("disabled");c.step_names||g.hide();a.traverse_titles_function();
