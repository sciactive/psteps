...
h=a.find(".step-content.step-active"),i=a.find(".step-title.step-active"),k,j;b>q||(a.find(".step-content").each(function(){e==b&&(k=f(this));e++}),e=1,a.find(".step-title").each(function(){e==b&&(j=f(this));e++}),c.steps_hide.call(h),d.removeClass("last-active"),g.removeClass("last-active"),h.hide().removeClass("step-active").addClass("last-active"),k.show().addClass("step-active step-visited step-loaded"),i.removeClass("step-active").addClass("disabled last-active"),j.addClass("step-active step-visited").removeClass("disabled"),
k.hasClass("step-loaded")||c.steps_onload.call(k),c.steps_show.call(k),c.traverse_titles=="visited"&&i.css("cursor","pointer"),r?r=false:a.trigger("validate_psteps"),a.toggle_buttons_function())};a.next_step_function=function(){var b=a.find(".step-title.step-active").prevAll(".step-title").length+2;a.go_to_step(b)};a.previous_step_function=function(){var b=a.find(".step-title.step-active").prevAll(".step-title").length;a.go_to_step(b)};a.traverse_titles_function=function(){a.change_traverse(c.traverse_titles)};
